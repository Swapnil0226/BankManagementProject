...
<body>
	<nav id="sidebar">
		<ul>
			...
			<li><a href="home.jsp" target="content-frame"
			...
			<li><a href="empRegistration.jsp"  target="content-frame"
				onclick="loadPage(event,'empRegistration.jsp')"> <svg
						xmlns="http://www.w3.org/2000/svg" height="24px"
						viewBox="0 0 24 24" width="24px" fill="#e8eaed">
      <path
							d="M15 12c2.7 0 5.5 1.28 6.98 3.55.29.45.02 1.05-.52 1.05h-13c-.54 0-.81-.6-.52-1.05C9.5 13.28 12.3 12 15 12zm-7.48.61c-.48.31-.9.67-1.27 1.06-.24.25-.67.05-.67-.28V11H3v-2h3.58V7c0-.33.43-.54.67-.28 1.11 1.19 1.85 2.84 1.85 4.65 0 .46-.04.91-.1 1.24zm6.98-3.61c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z" />
    </svg> <span>Register Employee</span>
			</a></li>
			...
			<li>
				<button onclick=toggleSubMenu(this) class="dropdown-btn">
					...
					<svg xmlns="http://www.w3.org/2000/svg" height="24px"
						viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
						<path
							d="M480-361q-8 0-15-2.5t-13-8.5L268-556q-11-11-11-28t11-28q11-11 28-11t28 11l156 156 156-156q11-11 28-11t28 11q11 11 11 28t-11 28L508-372q-6 6-13 8.5t-15 2.5Z" /></svg>
				</button>
				<ul class="sub-menu">
					<div>
						<li><a href="Cregistration.jsp" target="content-frame"
							onclick="loadPage(event,'Cregistration.jsp')">Add Customer</a></li>
						<li><a href="Cview.jsp" target="content-frame">View
								Customer</a></li>
			...
			<li>
				...
				<ul class="sub-menu">
					<div>
						...
						<li><a href="loan" target="content-frame">Check loan
								request</a></li>
					</div>
				</ul>
			</li>

			<a href="privacy_policy.jsp" target="content-frame"> <svg
					xmlns="http://www.w3.org/2000/svg" height="24px"
					viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
      <path
			...
			<li><a href="terms of service.jsp" target="content-frame"> <svg
						xmlns="http://www.w3.org/2000/svg" height="24px"
						viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
      <path
    ...
    </svg> <span>Terms of Service</span>
			</a></li>

			<li><a href="about us.jsp" target="content-frame"> <svg
						xmlns="http://www.w3.org/2000/svg" height="24px"
						viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
      <path
	...
	<main> <iframe name="content-frame"
		style="width: 100%; height: 100%; border: none" src="home.jsp"></iframe>
	</main>
